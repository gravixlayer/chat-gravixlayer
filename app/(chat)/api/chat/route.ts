...
// Tools removed for simple chat mode
...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Rate limiting is handled on the client side
    ...
    // Get user's API key and create appropriate provider
